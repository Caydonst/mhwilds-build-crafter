    ...
    return (
        ...
        >
            <div
                className={
                    open
                        ? `${styles.authContainer} ${styles.open}`
            ...
            >
                ...
                <div className={styles.authModeSwitcher}>
                    <div
                        className={`${styles.authModeSlider} ${view === "signup" ? styles.signup : ""
                            }`}
                    />

                    <button
                        type="button"
                        className={`${styles.authModeBtn} ${view === "login" ? styles.active : ""
                            }`}
                    ...
                    <button
                        type="button"
                        className={`${styles.authModeBtn} ${view === "signup" ? styles.active : ""
                            }`}
                ...
                <div className={styles.authViewport}>
                    <div
                        className={`${styles.authTrack} ${view === "signup"
                                ? styles.showSignup
                                : ""
                            }`}
                    >
                        ...
                        <section className={styles.authPanel}>
                            <div className={styles.authHeader}>
                                ...
                                <p>
                                    Sign in to save builds and access your
                                    account.
                                </p>
                            </div>
