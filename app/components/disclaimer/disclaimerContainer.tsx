...
type Props = {
    googleNoticeOpen: boolean;
    setGoogleNoticeOpen: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function DisclaimerContainer({ googleNoticeOpen, setGoogleNoticeOpen }: Props) {
    return (
        <div className={googleNoticeOpen ? `${styles.disclaimerWrapper} ${styles.open}` : styles.disclaimerWrapper}>
            <div className={styles.disclaimerContainer}>
                ...
                <button className={styles.closeBtn} onClick={() => setGoogleNoticeOpen(false)}>
                    <XMarkIcon />
                </button>
            </div>
        </div>
