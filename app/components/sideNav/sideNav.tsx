...
export default function SideNav({ open, setOpen }: Props) {
    ...
    return (
        <div className={open ? `${styles.sideNavContainer} ${styles.open}` : styles.sideNavContainer}>
            <button className={styles.closeBtn} onClick={() => setOpen(false)}><XMarkIcon /></button>
            <div className={styles.navButtons}>
                <Link className={styles.homeBtn} href={"/"} onClick={() => setOpen(false)}>Home</Link>
                <Link className={styles.builderBtn} href={"/builder"} onClick={() => setOpen(false)}>
                    Builder
                </Link>
